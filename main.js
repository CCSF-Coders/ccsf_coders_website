...
var _user$project$Router$router = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Router$Home, _evancz$url_parser$UrlParser$top),
		_1: {ctor: '[]'}
	});
var _user$project$Router$parseRoute = function (location) {
	return A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Router$router, location);
};

var _user$project$Types$Model = F2(
	function (a, b) {
		return {navbarState: a, route: b};
	});
var _user$project$Types$RouteChange = function (a) {
	return {ctor: 'RouteChange', _0: a};
};
var _user$project$Types$Scroll = function (a) {
...
var _user$project$Components_Navbar$navbar = function (state) {
	return A2(
				...
				_0: A2(
					_rundis$elm_bootstrap$Bootstrap_Navbar$itemLink,
					{
						...
						_0: _elm_lang$html$Html_Events$onClick(
							_user$project$Types$Scroll('calender')),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_rundis$elm_bootstrap$Bootstrap_Navbar$itemLink,
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_user$project$Types$Scroll('contact')),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href('https://github.com/CCSF-Coders/club-how-to/wiki'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Club How To'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Pages_Home$contactItem = F3(
	function (position, name, email) {
		return A2(
			_rundis$elm_bootstrap$Bootstrap_Table$tr,
			{ctor: '[]'},
			{
...
var _user$project$Pages_Home$icon = function (name) {
	return A2(
...
var _user$project$Pages_Home$socialIcon = F2(
	function (name, link) {
		return A2(
			_elm_lang$html$Html$a,
			{
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('social-icon'),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _user$project$Pages_Home$icon(name),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Pages_Home$contact = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
					...
					},
					{
						...
						_0: A2(
							...
							},
							{
								...
								_1: {
									ctor: '::',
									_0: A2(_user$project$Pages_Home$socialIcon, 'github-sqare', 'https://github.com/CCSF-Coders'),
									_1: {
										ctor: '::',
										_0: A2(_user$project$Pages_Home$socialIcon, 'facebook-square', 'https://www.facebook.com/groups/CCSFCoders/'),
										_1: {
											ctor: '::',
											_0: A2(_user$project$Pages_Home$socialIcon, 'youtube-square', 'https://www.youtube.com/user/CCSFCoders'),
											_1: {
												ctor: '::',
												_0: A2(_user$project$Pages_Home$socialIcon, 'google', 'https://groups.google.com/forum/#!forum/ccsfcoders'),
												_1: {
													ctor: '::',
													_0: A2(_user$project$Pages_Home$socialIcon, 'twitter-square', 'https://twitter.com/ccsfcoders'),
													_1: {
														ctor: '::',
														_0: A2(_user$project$Pages_Home$socialIcon, 'slack', 'https://ccsfcodersclub.slack.com/'),
														_1: {ctor: '[]'}
													}
												}
											}
			...
			_0: _rundis$elm_bootstrap$Bootstrap_Table$simpleTable(
				{
					...
					_1: A2(
						...
						{
							ctor: '::',
							_0: A3(_user$project$Pages_Home$contactItem, 'President', 'Michael Leung', 'mleung25@mail.ccsf.edu'),
							_1: {
								ctor: '::',
								_0: A3(_user$project$Pages_Home$contactItem, 'Advisor', 'Craig Persiko', 'craig.persiko@mail.ccsf.edu'),
								_1: {
									ctor: '::',
									_0: A3(_user$project$Pages_Home$contactItem, 'Treasurer', 'Elias Lawson-Fox', 'eliaslfox@gmail.com'),
									_1: {
										ctor: '::',
										_0: A3(_user$project$Pages_Home$contactItem, 'ICC Rep', 'Betty Zhang', 'bzhang6@mail.ccsf.edu'),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$Pages_Home$upcomingEvents = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('Upcoming Events'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Check back here when the semester starts for our calendar'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('calender'),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html_Attributes$attribute, 'src', 'https://www.google.com/calendar/embed?src=coders%40mail.ccsf.edu&ctz=America/Los_Angeles'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
...
var _user$project$Pages_Home$groupLink = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('The best way to get in contact with the group is to join our '),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$a,
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Google Group!'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Pages_Home$welcome = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _user$project$Pages_Home$meetingTimes = _rundis$elm_bootstrap$Bootstrap_Card$view(
	A3(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Spring Meeting Times'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Wendsdays, 4-6 PM Batmale Hall, Rm 451'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
		...
		_rundis$elm_bootstrap$Bootstrap_Card$config(
			{
				...
				_0: _rundis$elm_bootstrap$Bootstrap_Card$attrs(
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$id('meeting-times'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			})));
var _user$project$Pages_Home$view = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$container,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$Components_Navbar$navbar(model.navbarState),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Pages_Home$meetingTimes,
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _user$project$Pages_Home$welcome,
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
						...
						_0: A2(
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _user$project$Pages_Home$upcomingEvents,
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}),
							...
							_0: A2(
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _user$project$Pages_Home$contact,
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}),
								...
								_0: A2(
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _user$project$Pages_Home$groupLink,
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}),
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_rundis$elm_bootstrap$Bootstrap_Navbar$subscriptions, model.navbarState, _user$project$Types$NavbarMsg);
};
var _user$project$Main$renderPage = function (model) {
	var _p0 = model.route;
	if (_p0.ctor === 'Just') {
		return _user$project$Pages_Home$view(model);
	} else {
		return _elm_lang$core$Native_Utils.crashCase(
			'Main',
			{
				start: {line: 80, column: 5},
				end: {line: 85, column: 39}
			},
			_p0)('Invalid Page');
	}
};
var _user$project$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$renderPage(model),
				_1: {ctor: '[]'}
			}
		});
};
		...
		switch (_p2.ctor) {
			...
			case 'Scroll':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Ports$scroll(_p2._0)
				};
			default:
				return {
					ctor: '_Tuple2',
...
var _user$project$Main$init = function (location) {
	var _p3 = _rundis$elm_bootstrap$Bootstrap_Navbar$initialState(_user$project$Types$NavbarMsg);
	...
	return {
		...
		_0: A2(
			...
			navbarState,
			_user$project$Router$parseRoute(location)),
		_1: navbarCmd
	};
};
var _user$project$Main$main = A2(
	...
	function (location) {
		return _user$project$Types$RouteChange(
			_user$project$Router$parseRoute(location));
	},

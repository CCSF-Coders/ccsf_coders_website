...
<div class="blog">
  ...
  <div class="post">
    ...
    <p class="body">
      ...
      think we need a login system(discussion I've been having with Kevin). I think we could just have a sort of Blog Master, 
      who you send your post to, and they post it for you. But how it actually works isn't that important to me, as long 
      as it accessible and engaging to the club members.
    </p>
  </div>
  ...
  <div class="post">
    ...
    <p class="body">
      ...
      For example Ganni and Kevin made a game for an event at SETI, the game could be a toy in the toy box and 
      people who visit the site would be able to play it.  It will be a way to honor past club members and 
      serve as a sort of portfolio for current club members, by linking their Git Hub and social networking.

      When I create something I like to be able to create be able to show off the results, and I think the toy box will be a way to 
      encourage programmers to create an appealing final product.
    </p>
  </div>

  <div class="post">
    <h2>Never Complete</h2>
    <p class="body">
      I don't think the website should ever be finished. I would love to see it be as dynamic as possible 
      and change on a weekly basis. I would like to say that I am finished with it, but I will only consider it a success if it is 
      changed by others. If you have ideas, or feature suggestions, please build them and integrate them into the site and contact 
      me if you need me to explain the code. This website should belong to everyone, so I encourage you to make it yours.
    </p>
  </div>
  ...
  <div class="post">
    <h2>Thanks Kevin</h2>
    <p class="body">
      Kevin has fixed my broken code and implemented things I would never have been able to do by myself. He continues to want to 
      build more and more code for everything, I can't thank him enough.
    </p>

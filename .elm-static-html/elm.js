...
var _user$project$Partials_Nav$view = A2(
	_elm_lang$html$Html$nav,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('navbar navbar-inverse navbar-custom'),
		_1: {
			ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-target', '#navbarCollapse'),
						_1: {
							ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href('index.php'),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('CCSF Coders'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$id('navbarCollapse'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('index.php#events'),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
								...
								_0: A2(
									...
									{ctor: '[]'},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('index.php#contact'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('history.php'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
										...
										_0: A2(
											...
											{ctor: '[]'},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$href('codingchallenges.php'),
														_1: {ctor: '[]'}
													},
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('Challenges'),
														_1: {ctor: '[]'}
													}),
												_1: {ctor: '[]'}
											}),
											...
											_0: A2(
												...
												{ctor: '[]'},
												{
													...
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$href('lightningtalks.php'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
...
var _user$project$Partials_Quicklinks$view = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A3(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href('../styles/quicklinks-style.css'),
				_1: {
					ctor: '::',
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('quicklinks'),
					_1: {
						ctor: '::',
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$href('https://github.com/CCSF-Coders'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$id('social-github'),
								_1: {
									ctor: '::',
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$href('https://www.facebook.com/groups/CCSFCoders/'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('social-facebook'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$target('_blank'),
										_1: {ctor: '[]'}
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('fa fa-facebook-official'),
										_1: {ctor: '[]'}
									},
									{ctor: '[]'}),
								_1: {ctor: '[]'}
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$href('https://www.youtube.com/user/CCSFCoders'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$id('social-youtube'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$target('_blank'),
											_1: {ctor: '[]'}
								...
								},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('fa fa-youtube-square'),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {ctor: '[]'}
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href('https://groups.google.com/forum/#!forum/ccsfcoders'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('social-googlegroup'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$target('_blank'),
												_1: {ctor: '[]'}
									...
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('fa fa-google'),
												_1: {ctor: '[]'}
											},
											{ctor: '[]'}),
										_1: {ctor: '[]'}
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$href('https://twitter.com/ccsfcoders'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$id('social-twitter'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$target('_blank'),
													_1: {ctor: '[]'}
										...
										},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('fa fa-twitter-square'),
													_1: {ctor: '[]'}
												},
												{ctor: '[]'}),
											_1: {ctor: '[]'}
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$href('https://ccsfcodersclub.slack.com'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$id('social-slack'),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$target('_blank'),
														_1: {ctor: '[]'}
											...
											},
											{
												...
												_0: A2(
													_elm_lang$html$Html$i,
													{
														...
														_1: {
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('fa fa-slack'),
															_1: {ctor: '[]'}
														}
													},
													{ctor: '[]'}),
...
var _user$project$Partials_MeetingTimes$view = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
...
var _user$project$Partials_Header$view = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _user$project$Partials_Nav$view,
		_1: {
			ctor: '::',
			_0: _user$project$Partials_Quicklinks$view,
			_1: {
				ctor: '::',
				_0: _user$project$Partials_MeetingTimes$view,
				_1: {ctor: '[]'}
			}
		}
	});

var _user$project$Partials_IndexContent$view = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A3(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href('../styles/index-style.css'),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$rel('stylesheet'),
					_1: {
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('containter intro'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-lg-12 text-center'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									...
									_1: {
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('\n                        You\'ve found the door to the furthest reaches of human existence.\n                        Beyond which there is even more beyondness.\n                        We are the coders of CCSF. If you are interested in technology, coding, learning, advice or homework help, coders is the place for you!\n                        If not CCSF Coders club might be the place for you anyway.\n                        For exampledo you like the internet?\n                        DO you want to build more internet?\n                        WE CAN HELP!\n                        CCSF coders is a group of students of varying degrees of skill but all withan interest in computer science who\n                        meet up every week to work on project, discuss computer science, and complain about their classes.\n                        To join literally all you have to do is show up to our meetings,\n                        we dislike red tape, and hierarchical structures.\n                        At coders club we actively attempt to include and provide safe space for women, POC, and LGBT community members.\n                        '),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Partials_Footer$view = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: A3(
			...
			{
				ctor: '::',
				_0: A2(_elm_lang$html$Html_Attributes$attribute, 'src', 'https://code.jquery.com/jquery-2.1.3.min.js'),
				_1: {
					ctor: '::',
		...
		_1: {
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: A2(_elm_lang$html$Html_Attributes$attribute, 'src', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/js/bootstrap.min.js'),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$type_('text/javascript'),
						_1: {ctor: '[]'}
			...
			_1: {
				...
				_0: A3(
					...
					{
						ctor: '::',
						_0: A2(_elm_lang$html$Html_Attributes$attribute, 'src', '../scripts/quick.js'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$type_('text/javascript'),
							_1: {ctor: '[]'}
...
var _user$project$Index$view = A2(
	...
	{
		ctor: '::',
		_0: _user$project$Partials_Header$view,
		_1: {
			ctor: '::',
			_0: _user$project$Partials_IndexContent$view,
			_1: {
				ctor: '::',
				_0: _user$project$Partials_Footer$view,
				_1: {ctor: '[]'}
			}
		}
	});
